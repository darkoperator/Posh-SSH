...
<xsl:stylesheet version="1.0"
	...
	<xsl:import href="instrumentedlink-fr-FR.xslt" />
	<xsl:import href="ps-instrumentedlink.xslt" />
	<xsl:import href="ps-languageSpecificText.xslt" />
	<!--<xsl:import href="nestedtable.xslt" />-->
	<xsl:import href="codesnippet-fr-FR.xslt" />
	<xsl:import href="ps-codesnippet.xslt" />
	<xsl:import href="MultiViewTable-fr-FR.xslt" />
	<xsl:import href="search-fr-FR.xslt" />
	<xsl:import href="index-fr-FR.xslt" />
	<xsl:import href="toc-fr-FR.xslt" />
</xsl:stylesheet>