...
<xsl:stylesheet version="1.0" exclude-result-prefixes="msxsl" xmlns:msxsl="urn:schemas-microsoft-com:xslt" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:variable name="relatedLinks">相关链接</xsl:variable>
  <xsl:variable name="resizeIncreaseTooltip">单击展开</xsl:variable>
  <xsl:variable name="resizeResetTooltip">单击重置</xsl:variable>
</xsl:stylesheet>